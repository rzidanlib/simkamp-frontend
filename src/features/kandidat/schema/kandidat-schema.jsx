...
const kandidatSchema = z
  .object({
    ...
    kandidat_password: z.string().min(8, { message: 'Password minimal 8 karakter' }).optional(),
    ...
    kandidat_nomor_urut: z.number().min(1, { message: 'Nomor Urut harus di isi' }),
  })
